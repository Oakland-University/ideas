...
public class Constants {
  ...
  public static final String GET_ADMIN_IDEAS =
      "SELECT * from idea_post where " + "  category=? ORDER BY created_at ";
  ...
  public static final String IS_ADMIN =
      " SELECT exists(SELECT 1 " + "  FROM idea_approvers " + "  WHERE pidm = ?) ";
  ...
  public static final String CATEGORY_STRING =
      " SELECT category " + " FROM idea_categories " + " WHERE category_id = ? ";
